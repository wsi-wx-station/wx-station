...
/** Requires the promises module of the `fs` library.
* @requires fs
*/
const fs = require('fs').promises;

/** Whitelisted keys for extraction from the raw API data.
* @const {array}
*/
const WHITELIST = [
  'tempf',
...
/** Asynchronously write weather data to a file.
* @function
* @param {string} file Path to the file and its name.
* @param {object} data A JavaScript object literal containing weather data.
*/
...
/** Returns a cardinal direction from a compass degree value
* @private
* @function
* @param {string|number} deg Compass degrees (0-359)
* @return {string} The cardinal direction (e.g., `NNE` for North northeast)
*/
